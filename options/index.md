...
- `fig.keep`: (`'high'`; character or numeric) how plots in chunks should be kept; it takes five possible character values or a numeric vector (see the end of this section for an example)
  ...
  - If set to a numeric vector: interpret value of index of (low-level) plots to keep
